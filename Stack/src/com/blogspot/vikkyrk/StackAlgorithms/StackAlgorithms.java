...
public class StackAlgorithms {
    ...
    /*
     * In the stock span problem, we will solve a financial problem with the
     * help of stacks. Suppose, for a stock, we have a series of n daily price
     * quotes, the span of the stock's price on a given day is defined as the
     ...
     * price on the given day. Let, Price(i) = price of the stock on day "i".
